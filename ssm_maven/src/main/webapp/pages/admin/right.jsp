	...
	<div class="rightinfo">
		...
		<div class="tools">
			...
			<li style="padding-left:5px;">
				<label>用户名：</label><input type="text" name="title1" value="${numMap.username}" style="height:25px;border: 1px solid #a7b5bc;">
			...
			<c:forEach items="${paperList }" var="paper">
				<tr>
					...
					<td><%-- <a href="<%=basePath %>selectBook.shtml?id=${paper.id}"
						...
						<a href="<%=basePath %>zcp/findOrdering.shtml?id=${paper.id}"
