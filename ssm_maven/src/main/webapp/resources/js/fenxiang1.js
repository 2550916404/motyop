var $Vurl=$("#Vurl").val();//网页地址
var $Vtitle=$("#Vtitle").val();//标题
var $Vsummary=$("#Vsummary").val();//正文内容
var $Vpic=$("#Vpic").val();//图片路径
var BSHARE_SHOST_NAME = "//static.bshare.cn",
	BSHARE_BUTTON_HOST = "//bshare.optimix.asia",
			...
			createBuzzObject: function(a,
				...
				var c = e[a] = {
					...
					params: {
						type: 0,
						publisherUuid: "",
						url: $Vurl,         //网站路径,禁止使用location
						title: $Vtitle,     //标题
						summary: $Vsummary, //正文描述
						content: "",
						pic: $Vpic,         //图片路径
						pics: "",
						video: "",
...
(function(e, g, l) {
	...
	if (!(h.count > 0)) {
		...
		a.loadButtonStyle = function() {
			if (c.type != 15) {
				var f, e = b.style;
				if (b.beta) f = a.jsBasePath + "styles/bshareS888.js?v=20171207";
				else if (b.popjs) f = b.popjs;
				else if (b.style != -1 && (f = a.jsBasePath + "styles/bshareS" + (e > 1 && e < 6 ? e : 1) + ".js?v=20171207", b.pop == -1 && (e <= 1 || e >= 6))) f = "";
				f && d.loadScript(f)
			}
		};
		a.international =
			function(c) {
				b.lang == "zh" ? c() : d.loadScript(a.jsBasePath + "langs/bs-lang-" + b.lang + ".js?v=20171207", c)
			};
		a.start = function() {
			d.loadEngine && (d.loadEngine(e), a.loadOptions(), a.international(function() {
				if (!a.completed) {
					...
					a.createBox();
					b.mdiv >= 0 && c.type != 15 && d.loadScript(a.jsBasePath + "components/bsMore.js?v=20171207");
					...
					setTimeout(function() {
						h.viewed || a.view();
						setTimeout(function() {
							h.bShareLoad || d.loadScript(a.jsBasePath + "components/bsPlatforms.js?v=20171207")
						}, 3E3)
					}, 3E3);
					a.completed = !0
				}
		...
		a.init = function() {
			if (!a.isReady) a.isReady = !0, d.loadScript(a.shost + "/js/libs/fingerprint2.min.js"), d.loadScript(a.jsBasePath + "engines/bs-engine.js?v=20171207", a.start)
		};
		d.loadScript(a.jsBasePath + "components/bsStatic.js?v=20171207")
	}
